                ...
                <div :class="child.class">
                  <template v-if="child.children">
                    <template v-for="c in child.children" :key="c.id">
                      <div v-if="c.class === 'home-item-avatar'" :class="c.class"></div>
...
const items = ref([
  ...
  { id: 5, class: 'home-item-b5 home-item-circle', children: [
    { id: 1, class: 'home-item-b5-1' },
    { id: 2, class: 'home-item-b5-2', children: [
      { id: '1', class: 'home-item-avatar' }
    ] },
    { id: 3, class: 'home-item-b5-3' },
    { id: 4, class: 'home-item-b5-4', children: [
      {
        id: 'home.title',
        class: 'home-item-h1'
      },
