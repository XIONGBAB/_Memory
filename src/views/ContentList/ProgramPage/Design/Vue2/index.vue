                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>1. 在node安装目录下下新建两个文件夹</li>
                        <li>2. node_global 全局包下载存放</li>
                        <li>3. node_cache node缓存</li>
                      </ul>
                    </li>
                    <li>
                      修改路径
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  <ol>
                    <li>1. 导入vue.js 文件</li>
                    <li>2. new Vue() 构造函数，得到vm实例对象</li>
                    <li>3. 声明 el 和 data 数据节点</li>
                    <li>4. MVVM 的对应关系</li>
                  </ol>
                </li>
                <li>
                ...
                <li>
                  掌握vue中过滤器的基本用法
                  <ol>
                    <li>1. 全局过滤器 Vue .filter ( '过滤器名称'，function)</li>
                    <li>2. 私有过滤器 filters 节点</li>
                  </ol>
                </li>
              </ul>
